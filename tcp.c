...
#define MAX_PACKET_SIZE 962144444
#define PHI 0x9e3779b9

static unsigned long int Q[962144444], c = 3624353246;
static unsigned int floodPort;
static unsigned int packetsPerSecond;
static unsigned int sleepTime = 10;
static int limiter;
